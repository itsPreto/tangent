<template>
      ...
      <g class="label-container">
        ...
        <text class="text-container">
          ...
          >
            ...
            >
              <tspan 
                @dblclick.stop.prevent="handleLabelDoubleClick"
  ...
  const calculateConnectionPoints = () => {
    ...
    const messageYOffset = messageIndex * 120 + 4;
  
    const startPoint = {
      x: props.startNode.x + props.cardWidth,
      y: props.startNode.y + messageYOffset + 60
    };
