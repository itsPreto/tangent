  ...
  <div class="bottom-docker fixed bottom-4 left-1/2 transform -translate-x-1/2 z-40">
    <div class="docker-container">
      ...
      <div class="control-group action-group">
        ...
        <div class="action-item">
          <div class="action-label">Arrange</div>
          <button 
            @click="autoArrange"
            :class="['action-button', { 'processing': isArranging }]"
            :disabled="isArranging"
            title="Auto-arrange nodes by similarity"
          >
            <svg v-if="!isArranging" class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
